...
INSERT INTO user (username,email, password, activated) VALUES ('admin', 'admin@mail.me', '$2a$10$qcbyEFYeVmHEYh78TZRHJe.FMSuBwUxmyAXZPEX5tOy6ayJmNSBnK', true);
INSERT INTO user (username,email, password, activated) VALUES ('user', 'user@mail.me', '$2a$10$qcbyEFYeVmHEYh78TZRHJe.FMSuBwUxmyAXZPEX5tOy6ayJmNSBnK', true);
INSERT INTO user (username,email, password, activated) VALUES ('rajith', 'rajith@abc.com', '$2a$10$qcbyEFYeVmHEYh78TZRHJe.FMSuBwUxmyAXZPEX5tOy6ayJmNSBnK', true);
