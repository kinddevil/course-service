...
CREATE TABLE IF NOT EXISTS `cas`.`courses` (
  ...
  `campus_schools_id` BIGINT NULL,
  `course_id` BIGINT NULL,
  `course_name` VARCHAR(1024) NULL,
  `grade_id` BIGINT NULL,
  `grade_name` VARCHAR(2014) NULL,
  `school_calendar_id` BIGINT NULL,
  `school_calendar_name` VARCHAR(1024) NULL,
  `teacher_id` VARCHAR(256) NULL,
  `teacher_name` VARCHAR(1024) NULL,
  `course_description` TEXT(10240) NULL,
  `course_hours` INT NULL,
  `course_capacity` INT NULL,
  `classroom_type_id` BIGINT NULL,
  `classroom_type_name` VARCHAR(1024) NULL,
  `create_time` TIMESTAMP NULL,
  `update_time` TIMESTAMP NULL,
  `deleted` TINYINT NULL,
  `subject_id` BIGINT NULL,
  `subject_name` VARCHAR(1024) NULL,
  `course_mount` INT NULL,
  `li_calendar_id` BIGINT NULL,
  `li_calendar_name` VARCHAR(1024) NULL,
  `li_course_id` BIGINT NULL,
  `li_course_name` VARCHAR(1024) NULL,
  `li_lte` FLOAT NULL,
  `li_gte` FLOAT NULL,
  `li_subject_id` BIGINT NULL,
  `li_subject_name` VARCHAR(1024) NULL,
  `classroom_type_weight` INT NULL,
  `award_weight` TEXT NULL,
  PRIMARY KEY (`id`, `cuid`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `cas`.`user_action`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cas`.`user_action` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `user_name` VARCHAR(512) NULL,
  `user_type` VARCHAR(128) NULL,
  `school_id` BIGINT NULL,
...
-- -----------------------------------------------------
-- Table `cas`.`dict_copy1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cas`.`dict_copy1` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `value` VARCHAR(1024) NULL,
  `key` VARCHAR(1024) NULL,
  `school_id` BIGINT NULL,
...
-- Table `cas`.`calendar`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cas`.`calendar` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(1024) NULL,
  `school_id` BIGINT NULL,
  `desc` VARCHAR(2048) NULL,
...
-- -----------------------------------------------------
-- Table `cas`.`calendar_copy1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cas`.`calendar_copy1` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(1024) NULL,
  `school_id` BIGINT NULL,
  `desc` VARCHAR(2048) NULL,
...
-- -----------------------------------------------------
-- Table `cas`.`calendar_copy2`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cas`.`calendar_copy2` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(1024) NULL,
  `school_id` BIGINT NULL,
  `desc` VARCHAR(2048) NULL,
...
-- -----------------------------------------------------
-- Table `cas`.`calendar_copy3`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `cas`.`calendar_copy3` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(1024) NULL,
  `school_id` BIGINT NULL,
  `desc` VARCHAR(2048) NULL,
